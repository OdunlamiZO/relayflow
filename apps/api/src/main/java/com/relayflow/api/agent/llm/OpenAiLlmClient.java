...
public class OpenAiLlmClient extends AbstractOpenAiCompatibleLlmClient {
    ...
    private static final String MODEL_REDIS_KEY = "platform:llm:openai:model";

    @Value("${relayflow.llm.openai.api-key}")
    ...
    public OpenAiLlmClient(ObjectMapper objectMapper, LlmPlatformConfigService configService) {
        super(objectMapper);
