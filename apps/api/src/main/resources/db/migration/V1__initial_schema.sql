...
create table conversations (
    ...
    -- Set when the AI agent escalates (keyword match or LLM-requested); cleared
    -- when a human agent sends the next reply.
...
-- Single-use links for setting a new password — self-requested, or generated by a
-- workspace owner on a member's behalf. State is tracked via used_at rather than a
-- soft-delete column, same as workspace_invites.
