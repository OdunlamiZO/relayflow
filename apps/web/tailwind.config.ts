  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "teal-bg-hover": "var(--color-teal-bg-hover, #99F6E4)",
        "teal-text-hover": "var(--color-teal-text-hover, #0F766E)",
        "teal-border-hover": "var(--color-teal-border-hover, #14B8A6)",
        "orange-bg": "var(--color-orange-bg, #FFEDD5)",
        "orange-text": "var(--color-orange-text, #7C2D12)",
        "orange-border": "var(--color-orange-border, #FB923C)",
